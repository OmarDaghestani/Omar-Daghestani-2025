...
export const SkillsSection = memo(function SkillsSection() {
  ...
  return (
    ...
    >
      ...
      <p>Total Categories: {skillCategories.length}</p>
      ...
      <SectionWrapper id="skills">
        ...
        <div className="bg-red-500 text-white p-4 mb-4 text-center space-y-2">
          ...
          <div className="text-xs mt-2">
            If you see this banner, the section is rendering. If skills
            don&apos;t show below, it&apos;s a styling issue.
          </div>
        </div>
          ...
          {filteredCategories.length > 0 ? (
            ...
            <div className="text-center py-8">
              <div className="bg-yellow-500 text-black p-4 mb-4">
                ⚠️ NO CATEGORIES FOUND - This means the filtering is removing
                all categories
              </div>
